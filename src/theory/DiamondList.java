...
public class DiamondList<T>
{
    ...
    private SimpleStack<ValueBag<T>> breakpoints;
    private int size;
    ...
    public void addOnTop(T element)
    {
        ...
        {
            ValueBag<T> newBag = new ValueBag<>();
    ...
    public void insertBeforePointer(T element)
    {
        ...
        {
            ValueBag<T> newBag = new ValueBag<T>();
            lastCreatedValueBag = newBag;
            newBag.content = element;
    ...
    public void pushBreakpoint()
    {
        if ( breakpoints == null )
        {
            breakpoints = new SimpleStack<ValueBag<T>>();
        }
    ...
    public class ValueBag<S>
    {
        public ValueBag<S> previous = null;
        public ValueBag<S> next = null;
